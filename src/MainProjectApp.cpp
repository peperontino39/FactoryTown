...
void MainProjectApp::prepareSettings(Settings * settings)
{
	...
	settings->setTitle("gjhsdallkhufhbkjsaoiuguhjuytgfvbjuytfggfhvbjhkuytrdfcvbnjhkuiytrdfxcvbnjkuiytrdfvcbnjkloiuytrfdgcvbnmkjliuytred");
	//settings->setFullScreen(1);
}
