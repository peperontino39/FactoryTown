...
#include "../../../Category/Conveyor/ConveyorBase/ConveyorBase.h"
#include "../../../Category/Conveyor/NomalConveyor/NomalConveyor.h"
...
ci::Vec2i MapChipDate::directionToVec()
{
	return conveyor->directionToVec();
}

bool MapChipDate::isEmpty()
{
	return conveyor->getDirection() == NON;
}
